...
export default function InstructorSettings({ open, onOpenChange }: InstructorSettingsProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center gap-4">
            <DialogTitle className="text-2xl">Instructor Settings</DialogTitle>
          ...
          <DialogDescription>
            Manage your instructor profile and security settings
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  <Avatar className="w-20 h-20">
                    ...
                    <AvatarFallback className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t">
                  <p className="text-sm text-muted-foreground">
                    As an instructor, you can create and manage quizzes, monitor student progress, 
